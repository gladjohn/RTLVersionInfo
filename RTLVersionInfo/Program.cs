...
namespace RTLVersionInfo
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine(Win32VersionApi.GetOsVersionInfo());
            Console.Read();
        }
        ...
        internal static class Win32VersionApi
        {
            ...
            public static string GetOsVersionInfo()
            {
                ...
                var OsVersionInfo = new OSVERSIONINFOEXW { dwOSVersionInfoSize = Marshal.SizeOf(typeof(OSVERSIONINFOEXW)) };
                    ...
                    {
                        return string.Format("Product Type {0}. Major Version {1}. Build Number {2}.", OsVersionInfo.wProductType, OsVersionInfo.dwMajorVersion, OsVersionInfo.dwBuildNumber);
                    }
                    else
                    {
                        return "RTL Info Failed";
                    }
